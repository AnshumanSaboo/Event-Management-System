(function() {
    ...
    var canvas = document.getElementById('scene-5');
    console.log(canvas);
    ...
    var dotTexture = loader.load('/devassets/img/dotTexture.png');
    ...
    var shaderMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: document.getElementById("wrapVertexShader5").textContent,
        fragmentShader: document.getElementById("wrapFragmentShader5").textContent,
        transparent:true
    });
